  ...
  <div id="app">
    <div class="container">
      ...
      <section id="projects">
        ...
        <div class="row">
          <portfolio-item v-for='(item,index) in dataSrc' :key='index' :name="item.name" :link='item.link'
            :role='item.role' :caption='item.caption' :imgSrc='item.imgSrc' :overlayText='item.overlayText'
            :staticSrc='item.staticSrc' :bgColor='item.bgColor' :isMobile='mobileWidth'>
          </portfolio-item>
        </div>
      </section>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        aboutPhoto: {
          animated: require('@/assets/img/about/bus-selfie-animated.gif'),
          static: require('@/assets/img/about/bus-selfie-static.jpg')
        }
      }
    },
    computed: {
